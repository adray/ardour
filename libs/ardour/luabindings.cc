...
LuaBindings::common (lua_State* L)
{
	...
	luabridge::getGlobalNamespace (L)
		...
		.addFunction ("add_region", (void (Playlist::*)(boost::shared_ptr<Region>, framepos_t, bool))&Playlist::add_region)
		...
		.addFunction ("duplicate", (void (Playlist::*)(boost::shared_ptr<Region>, const AudioMusic&, const AudioMusic&, float))&Playlist::duplicate)
		...
		/* editing operations */
		.addFunction ("set_length", (void (Region::*)(framepos_t, int32_t))&Region::set_length)
		.addFunction ("set_start",  (void (Region::*)(framepos_t))&Region::set_start)
		.addFunction ("set_position_frame",  (void (Region::*)(framepos_t))&Region::set_position_frame)
		.addFunction ("set_position_qnote",  (void (Region::*)(double))&Region::set_position_qnote)
		...
		.addFunction ("trim_front", (void (Region::*)(framepos_t))&Region::trim_front)
		...
		.addFunction ("start_qn", &Region::start_qn)
		.addFunction ("length_qn", &Region::length_qn)
		.endClass ()
	...
	// std::list<boost::weak_ptr<Source> >
		...
		.addFunction ("note_types_per_minute",  (const double& (Tempo::*)() const)&Tempo::note_types_per_minute)
