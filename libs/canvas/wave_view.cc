...
WaveView::optimal_image_width_samples () const
{
	...
	framecnt_t new_sample_count = std::max (canvas_width_samples, one_tenth_of_second);
	 ...
	 */
	double multiplier = g_random_double_range (1.4, 1.8);

	new_sample_count = new_sample_count * multiplier;
