...
Editor::register_region_actions ()
{
	...
	register_toggle_region_action (_region_actions, RegionActionTarget (SelectedRegions|EnteredRegions), "toggle-region-lock-style", _("Glue to Music"), sigc::mem_fun (*this, &Editor::toggle_region_lock_style));
